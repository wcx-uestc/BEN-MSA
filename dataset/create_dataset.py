...
class MOSI:
    def __init__(self, config):
        ...
        try:
            ...
            pickle_filename = "D:/GoogleDownload/drive-download-20230424T142808Z-002/MOSI/mosi_data_noalign.pkl"
            csv_filename = "D:/GoogleDownload/drive-download-20230424T142808Z-002/MOSI/MOSI-label.csv"
            ...
            # Save pickles
            to_pickle(train, "D:/GoogleDownload/drive-download-20230424T142808Z-002/MOSI/train.pkl")
            to_pickle(dev, "D:/GoogleDownload/drive-download-20230424T142808Z-002/MOSI/dev.pkl")
            to_pickle(test, "D:/GoogleDownload/drive-download-20230424T142808Z-002/MOSI/test.pkl")
...
class MOSEI:
    def __init__(self, config):
        ...
        try:
            ...
            # self.dev = load_pickle(data_path + '/dev.pkl')
            # self.test = load_pickle(data_path + '/test.pkl')
            self.train = load_pickle('/home/liufeng2/paper/dataset/train.pkl')
            self.dev = load_pickle('/home/liufeng2/paper/dataset/dev.pkl')
            self.test = load_pickle('/home/liufeng2/paper/dataset/test.pkl')
            self.pretrained_emb, self.word2id = None, None
        except:
