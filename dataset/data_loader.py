...
from dataset.create_dataset import MOSI, MOSEI, PAD, UNK
...
def get_loader(config, shuffle=True):
    ...
    if config.mode == 'train':
        ...
        print("train dataset has " + str(len(dataset)) + " datapoints")
    elif config.mode == 'valid':
        config.n_valid = len(dataset)
        print("valid dataset has " + str(len(dataset)) + " datapoints")
    elif config.mode == 'test':
        config.n_test = len(dataset)
        print("test dataset has " + str(len(dataset)) + " datapoints")
